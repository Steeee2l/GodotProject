...
# 시작 예비탄 150(5탄창). 240은 첫 런부터 남아돌았다(유저: "탄약이 진짜 너무
# 많다"). 압박은 '아껴 쏘기'가 아니라 '싸움을 고르기'에서 나와야 한다는 원칙은
# 그대로 — 드랍은 소프트캡(get_ammo_scarcity_multiplier)이 조절한다.
...
const SAJA_FACILITY_CONTRACTS: Array[Dictionary] = [
	{
		...
		"accept_dialogue": [
			"생산기가 하나도 없다. 하나만 세우면 애들이 일을 시작해.",
			"기초 부품 세 개. 없으면 그냥 와. 그게 더 중요하다.",
		],
		"complete_dialogue": [
			"세 개나. …고맙다. 애들 불러서 바로 세운다.",
			"이제 이 쉘터도 제 밥벌이를 한다. 네 덕이야.",
		],
		"objective": "기초 부품 확보",
		"metric": "parts",
		"target": 3,
		...
		"lore": "사자는 뭐든 먼저 숫자로 적는다. 부품 세 개, 주민 한 명, 통조림 여덟 개. 사람 수만 두 번 센다. 한 번 세고, 잠깐 있다가 다시 센다.",
	},
	{
		"id": "street_patrol",
		"title": "운반로 정리",
		...
		"accept_dialogue": [
			"캣닢 장비를 옮겨야 하는데 길목에 약탈대가 있다.",
			"망루에서 세어 보니 넷. 장비보다 네가 먼저다.",
		],
		"complete_dialogue": [
			"길 뚫렸다고 애들이 난리다.",
			"캣닢 냄새 나면 애들이 잘 잔다. 고맙다.",
		],
		"objective": "운반로 위협 제거",
		"metric": "kills",
		"target": 4,
		...
		"lore": "캣닢 생산량을 하루 단위로 적는다. 장부 양식이 사람 있던 시절 것과 똑같다. 아파트 관리사무소에서 쓰던 서식이다.",
	},
	{
		"id": "lost_notices",
		"title": "정비 기록 두 건",
		...
		"accept_dialogue": [
			"망가진 총들 좀 살려 보고 싶다. 옛날 정비 기록이 있어야 해.",
			"현장 기록 두 건. 종이라 무겁지도 않아.",
		],
		"complete_dialogue": [
			"이거다, 이거. …옛날 생각 난다.",
			"주운 총은 버리지 말고 작업대로. 고쳐 쓰는 맛이 있어.",
		],
		"objective": "정비 기록 조사",
		"metric": "lore",
		"target": 2,
		"reward": {"xp": 120, "canned_food": 3, "medkits": 1, "scrap": 300},
		"lore_title": "사자의 기록 03 · 자물쇠",
		"lore": "창고 자물쇠를 손으로 만져 보고 고개를 끄덕인다. 열쇠 없이 여는 법도 안다. 어디서 배웠냐고 물으면 딴 얘기를 한다.",
	},
	{
		"id": "salvage_cipher",
		"title": "설비 분해 두 건",
		...
		"accept_dialogue": [
			"버려진 차나 설비, 그냥 지나치기 아깝지 않냐.",
			"두 개만 뜯어 봐. 뭐가 쓸 만한지는 손이 먼저 안다.",
		],
		"complete_dialogue": [
			"부품 상태 좋네. 작업대 애들이 신났다.",
			"좋은 부품 하나가 총 한 자루보다 오래 간다. …우리 집 사람이 하던 말이야.",
		],
		"objective": "현장 설비 분해",
		"metric": "salvage",
		"target": 2,
		...
		"lore": "창고에 라벨 없는 상자가 몇 개 있다. 목록에도 없다. 열어 보면 전부 사료다. 사람 음식은 한 봉지도 없다. 물어보면 규정 얘기를 한다.",
	},
	{
		"id": "rescue_route",
		"title": "빈 침상 한 자리",
		...
		"accept_dialogue": [
			"침상이 하나 빈다. 빈 침대는… 영 못 보겠다.",
			"밖에 아직 혼자 버티는 애들 있어. 하나만 데려와.",
		],
		"complete_dialogue": [
		...
		"lore_title": "사자의 기록 05 · 새벽",
		"lore": "새벽에 자리를 비운다. 물 받으러 간다고 한다. 물통은 늘 비어서 돌아온다. 대신 발에 시장 흙이 묻어 있다.",
	},
	{
		"id": "field_operation",
		"title": "현장 작전 한 건",
		...
		"accept_dialogue": [
			"이제 내가 시킨 일만 할 놈은 아니지.",
			"현장 작전 하나, 네 방식대로 끝내고 와. 여기서 기다린다.",
		],
		"complete_dialogue": [
			"얼굴 보니 잘 끝났구나. 됐다.",
			"이 쉘터가 네 덕에 거점 소리를 듣는다. 다음 것도 맡아 줄래.",
		],
		"objective": "현장 작전 완료",
		...
		"lore": "이곳을 늘 ‘거점’이라고 부른다. 집이라고 부른 적은 없다. 수첩 첫 장에 ‘집’이라고 적힌 주소가 하나 있다. 101동이다.",
	},
]
const IRON_SPECIAL_MISSIONS: Array[Dictionary] = [
	...
	},
	{
		...
		"accept_dialogue": "싸움은 총을 쏜 뒤에도 끝나지 않는다. 무거운 부품을 끝까지 들고 오는 힘부터 보겠다. 설비 다섯 개를 분해해 와라.",
		"complete_dialogue": "호흡이 안 무너졌군. 이제 도망칠 때도 쫓을 때도 한 걸음 더 갈 수 있다.",
	},
	{
...
const EQUIPMENT_DEFINITIONS := {
	"scav_vest": {
		...
		"description": "얇은 철판을 덧댄 경량 조끼. 받는 피해를 15% 줄입니다.",
	},
	"riot_vest": {
...
const RESIDENT_NAME_POOL: Array[String] = [
	...
	# "먼지"는 주인공 이름이라 뺐다 — 주민 명단에 주인공과 같은 이름이 뜨면
...
const SAJA_CHATTER := {
	"early": [
		{"title": "정수기", "lines": [
			"정수기가 또 샌다. 어제 고쳤는데 또 새.",
			"이거 고치면 딴 데가 새. 원래 그래.",
			"…물은 있어. 걱정하지 마.",
		]},
		{"title": "네 몫", "lines": [
			"오늘 국물 있어. 네 거 따로 덜어 놨어.",
			"왜 봐. 밖에 나가는 게 너 하나니까 그렇지. 별 뜻 없어.",
		]},
		{"title": "발소리", "lines": [
			"망루 애들이 그러더라. 네 발소리는 멀리서도 알겠다고.",
			"그거 자랑 아니야. 놈들도 귀 있어. 좀 조용히 걸어.",
		]},
		{"title": "사료", "lines": [
			"사료 먹었어? 한 줌.",
			"맛없는 거 알아. 나도 알아. 그냥 먹어.",
			"…왜냐고는 묻지 마.",
		]},
		{"title": "까진 데", "lines": [
			"지난번에 여기 까졌잖아. 아물었어?",
	...
	"mid": [
		...
		{"title": "남대문", "lines": [
			"남대문 옛날에 나도 자주 갔어. 생선 대가리 공짜로 주던 할머니 있었는데.",
			"어떻게 됐는지는 몰라. 가면 좀 봐 줘.",
			"…아니다. 보지 마. 알아서 뭐 해.",
		]},
		{"title": "상자", "lines": [
			"네가 가져온 거 상자에 넣어 뒀어. 잃어버릴 일 없어.",
			"보고 싶으면 말해. 꺼내 줄게.",
			"…자주 보진 마.",
		]},
		{"title": "잠", "lines": [
			"요즘 잠을 설쳐. 나이 먹으면 새벽에 깨.",
			"너도 자는 얼굴이 안 편하더라.",
			"오늘은 좀 자.",
		]},
		{"title": "주홍", "lines": [
			"주홍이 왔다 갔다며.",
			"걔가 나 싫어하는 거 알아. 이유도 알아.",
			"…아니다. 몰라. 아무튼 네 뒤는 봐 줄 거야.",
		]},
		{"title": "어두운 데", "lines": [
			"을지로 밑은 어두워. 등 챙겨 가.",
			"나는 어두운 데 싫어해. 그래서 여기 등 안 꺼.",
			"전기 아깝다고 애들이 뭐라 하는데, 그래도 안 꺼.",
		]},
	],
	"late": [
		{"title": "밥은 밥", "lines": [
			"밥 안 먹냐.",
			"안 먹을 거면 말을 해. 괜히 데워 놨잖아.",
			"…먹어. 식는다.",
		]},
		{"title": "등", "lines": [
			"등 안 끈다고 뭐라 하지 마.",
...
func get_pending_shelter_story_event() -> Dictionary:
	...
	if not saja_intro_seen:
		return {
			...
			# 맞는 무뚝뚝한 반말 — 말은 뚝뚝, 챙김은 행동으로. v4(2026-09-04): 설명 대사를
			# 걷어내고 짧은 실제 말로. "식는다"는 전체에서 late 잡담 '밥은 밥' 한 번만 쓴다.
			# 다정함으로 의심을 차단한다는 설계는 유지: 의심의 단서는 수집 기록물
			# ('사자의 기록')과 주홍의 입에만. '이름을 적는 버릇'은 여기선 아저씨의
			# 습관으로 읽히고, 존2~3에서 명단의 필체로 되짚였을 때에야 소름이 된다.
			"lines": [
				"총 좀 내려 봐.",
				"아니 겨누라는 게 아니라… 됐다. 들어와. 문 닫아야 돼. 여기 문이 잘 안 닫혀. 밑에가 휘어 가지고.",
				"밥 먹었어? …안 먹었네. 얼굴에 써 있어.",
				"국 있어. 아침에 한 거라 좀 짤 거야.",
				"여기 밥은 하루 두 번이야. 아침 여섯 시, 저녁 일곱 시. 늦으면 없어.",
				"…아니다. 늦으면 말해. 남겨 놓을게.",
				"이건 사료. 매일 한 줌씩 먹어. 맛없는 거 아는데 그냥 먹어. 왜냐고는 묻지 마.",
				"이름이 {name}이라고 했지. 적어 놓을게. 받침 틀리면 말해.",
				"나는 사자야. 여기 살림 봐. 뭐 없으면 나한테 말해.",
	...
	if survived_return_count >= 3 and not juhong_intro_seen:
		return {
			...
			"lines": [
				"주홍이야. 방송국에서 봤지.",
				"사자가 내 얘기 했지. 걸러 들으라고 했을 거야.",
				"그래, 걸러 들어. 대신 이것도 걸러 봐.",
				"그 노란 놈, 너한테 잘해 주지. 밥도 주고 이름도 적어 주고.",
				"…나한테도 그랬어.",
	...
	if survived_return_count >= 1 and not saja_second_run_intro_seen:
		return {
			...
			"lines": [
				"왔냐. 밥부터. 데워 놨어.",
				"벨트는 못 찾았지. 됐어. 없으면 없는 거지 뭐.",
				"종로역 말이야. 그날 밤에 거기만 끝까지 불이 켜져 있었어.",
				"…아니다. 그건 됐고.",
				"철근이 너 찾더라. 무뚝뚝한데 나쁜 놈은 아니야. 시간 나면 가 봐.",
			],
		}
	...
	if (
		...
		return {
			...
			"title": "쇳내",
			"lines": [
				"가방에서 쇳내 나. 스프링에 렌즈까지 들었네.",
				"작업대에 갖다 대. 하나씩 달면 총이 조금씩 나아져.",
				"…밖에 나가는 게 너 하나잖아. 그게 자꾸 걸려서 그래.",
			],
		}
	if rescued_workers > saja_seen_resident_count:
		return {
			...
			"lines": [
				"하나 데려왔네.",
				"이름부터 물어봐. 적어 둬야지. 오늘부터 식구야.",
				"사료도 한 줌 줘. 새로 온 애는 꼭 챙겨야 돼.",
				"밥은 내가 챙긴다. 너는 몸만 성하게 다녀.",
			],
		}
	if total_boss_kills > saja_seen_boss_kills:
		return {
			...
			"title": "바깥 소문",
			"lines": [
				"밖이 시끄러웠다며. 애들이 네 얘기만 해.",
				"무리하지 마. 그런 놈 자리는 금방 다른 놈이 채워.",
				"…오늘은 자랑해도 돼. 한 그릇 더 퍼 줄게.",
			],
		}
	...
	for zone_id in MAIN_MISSION_CATALOG.ZONE_ORDER:
		...
		# 마지막 구역(남산)을 끝내면 안내가 아니라 엔딩이다. 예전에는 여기서도
		# "이제 남산이지"가 떠서, 이미 다녀온 곳을 다시 가리키고 있었다.
		if next_zone_id.is_empty():
			return {
				...
				"lines": [
					...
					"서른여섯?",
					"아니야. 스물일곱이야. 내가 셌어.",
					"아홉 명이 못 들어갔어. 셔터 앞에 서 있었어. 내가 봤어.",
					"…내가 내렸으니까.",
					"더는 못 받는다고, 닫으라고 하길래.",
					"밖에 아직 있다고 말은 했어. 했는데도 닫으라고 해서.",
					"반년 동안 그 아홉 얼굴을 세면서 살았어.",
					"…다른 문으로 들어갔다고?",
					"…",
					"{name:아/야}.",
					"가자. 나 좀 데려가 줘.",
		...
		var closing_lines: Array[String] = [
			"%s 갔다 왔다며. 앉아. 밥부터." % zone_name,
			"가져온 건 상자에 넣어 뒀어. 잃어버릴 일 없어.",
			"다음은 %s겠지. 가지 말라고 해도 갈 거잖아." % next_name,
		]
		# 해금 조건("쉘터 티어 2" 같은 시스템 문구)은 대사에 섞지 않는다 —
		# 몰입이 깨진다(보이스 바이블). 쉘터 진입 토스트 큐로 보낸다.
		...
		closing_lines.append("준비되면 그쪽 길도 열려. 서두를 거 없어.")
		return {
			"id": "saja_main_chain_%s" % chain_zone_id,
			"speaker": "사자",
			"title": "먼 길",
	...
	if subway_story_stage > saja_seen_subway_stage:
		return {
			...
			"title": "지하의 소리",
			"lines": [
				"지하에서 신호가 다시 잡힌대. 기계는 저 혼자 안 켜져.",
				"…내려갈 거지. 등 챙겨 가.",
				"주홍이 먼저 갔을 거야. 만나면 내 안부 전해 줘. 안 믿겠지만.",
			],
		}
...
func get_pending_juhong_event() -> Dictionary:
	...
	if (
		...
		return {
			...
			"title": "돌아온 목소리",
			"lines": [
				"죽은 줄 알았지? 하수구 애들은 그렇게 쉽게 안 죽어.",
				"내 무전기는 못 찾았더라. 네가 버리고 간 건 아니라고 해 두자.",
				"다음 출정부터 다시 같이 간다. 빚 정산은 밖에서 하자.",
			],
		}
	...
	if subway_story_stage >= 1 and not juhong_seen_events.has("subway_signal"):
		return {
			...
			"title": "지하 목소리",
			"lines": [
				"지하 신호는 너도 들었지. 구조 요청처럼 들리지만 아니야.",
				"같은 문장이 한 글자도 안 틀리고 반복돼. 그건 녹음이야.",
				"산 사람 목소리가 아니야. 누가 녹음을 틀어 놓고 사람을 부르는 거지.",
	...
	if total_boss_kills >= 1 and not juhong_seen_events.has("boss_vacancy"):
		return {
			...
			"title": "빈자리",
			"lines": [
				"네가 비운 자리에 벌써 다른 무리가 기어들어 오고 있어.",
				"우리가 세진 게 아니야. 그놈들 사이의 힘 균형을 우리가 건드린 거지.",
				"싸우기 전에 누가 누구를 미워하는지부터 알아봐. 그걸 알면 총알을 아낄 수 있어.",
			],
		}
	return {}
...
# ── 탄약 소프트캡(2026-08-30 유저: "첫 런인데 탄약이 너무 많다, 쫄깃하게") ──
# 예비탄이 AMMO_SCARCITY_FREE_ROUNDS 아래면 지금처럼 넉넉히 나오고, 그 위로는
# 쌓일수록 획득량과 드랍 확률이 함께 줄어 AMMO_SCARCITY_FLOOR까지 떨어진다.
# "쏠 만큼은 있는데 쟁이지는 못한다"가 목표다. 하드캡이 아니라 완만한 경사라
# 플레이어는 벽을 느끼지 않고 자연스럽게 탄을 아끼기 시작한다.
const AMMO_SCARCITY_FREE_ROUNDS := 120
const AMMO_SCARCITY_SPAN_ROUNDS := 240
const AMMO_SCARCITY_FLOOR := 0.25


func get_ammo_scarcity_multiplier(ammo_id: String) -> float:
	var reserve := get_ammo_count(ammo_id)
	if reserve <= AMMO_SCARCITY_FREE_ROUNDS:
		return 1.0
	var over := float(reserve - AMMO_SCARCITY_FREE_ROUNDS) / float(AMMO_SCARCITY_SPAN_ROUNDS)
	return clampf(1.0 - over, AMMO_SCARCITY_FLOOR, 1.0)
