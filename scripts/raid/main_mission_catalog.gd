	...
	"jongno_outskirts": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "flash", "color": "#62c9ca", "pulses": 2, "duration": 0.9},
					{
						...
						"lines": [
							"라디오에서 신호가 나왔다. 나는 그 신호를 따라 여기까지 왔다.",
							"신호를 보낸 곳은 저 지하철역이다.",
								"역 입구가 잠겨 있다. 밖에서 잠근 게 아니라 안에서 잠갔다.",
							"안에서 잠갔다면, 잠근 누군가가 안에 있었다는 뜻이다.",
							"오늘 알고 싶은 건 하나다. 이 동네 사람들이 다 어디로 갔을까.",
							"역무실 창문 너머로 단말 화면이 아직 켜져 있다.",
								"먼저 역무실 단말부터 열어 본다.",
						],
					},
				...
				"point_0": [
					{
						...
						"title": "역무실 단말 · 화면",
						"lines": [
							"화면에 명단이 떠 있다. 이름이 스물일곱 개다.",
							"전부 이 동네에 살던 사람들 이름이다.",
							"맨 위에 도장이 하나 찍혀 있다. ‘수거 완료’라고 적혀 있다.",
							"수거는 사람한테 쓰는 말이 아니다. 물건을 거둬 갈 때 쓰는 말이다.",
							"누가 이 사람들을 물건처럼 세어서 거둬 갔다. 그런 뜻이다.",
								"누가 이 사람들을 세어 놓은 걸까.",
								"승강장 스피커 선이 비상 발전기로 이어져 있다.",
								"발전기를 살리면 스피커가 뭘 틀었는지 들을 수 있다.",
						],
					},
				],
				"point_1": [
						...
						"options": [
							{
								...
								"effect": {
									...
									"monologue": [
										"업고 가면 나는 느려진다. 느려지면 위험하다.",
										"그래도 이 녀석은 그날 밤을 직접 본 눈이다. 데려간다.",
									],
								},
							},
							{
								...
								"effect": {
									...
									"monologue": [
										"다시 오겠다고 말했다. 이 녀석은 내 말을 안 믿는 눈치였다.",
										"들을 이야기는 다 들었다. 오늘은 그걸로 됐다.",
									],
								},
							},
						],
				...
				"recovery": [
					{
						...
						"lines": [
							...
							"화물칸 안에서 무언가 두드리는 소리가 난다.",
							"사람이 두드리는 소리는 아니다. 그러기엔 너무 작다.",
								"무슨 소리일까. 일단 이 화물칸을 떼어서 들고 나간다.",
						],
					},
				],
			},
			"points": [
				...
				},
				{
					...
					"complete_monologue": [
						"전기가 들어오자 스피커가 혼자 방송을 시작했다.",
							"녹음된 여자 목소리다.",
						"〈주민 여러분, 대피 차량이 도착했습니다. 소지품은 두고 오십시오.〉",
						"이 목소리는 나를 강 건너로 부른 라디오 목소리와 같다.",
						"사람들을 데려간 방송과 나를 부른 신호가 같은 곳에서 나왔다.",
							"우연일 리가 없다.",
						"승강장 끝에 방역 도장이 찍힌 화물칸이 서 있다.",
							"저 화물칸을 챙겨서 나간다.",
					],
				},
			],
			...
			"carry_monologue": [
				"오늘 알아낸 것은 이렇다. 사람들은 납치당한 게 아니다.",
					"방송이 부르니까 사람들이 제 발로 걸어 나갔다.",
				"명단도 있었다. 스물일곱 명이다.",
					"누가 도장까지 찍어 가며 사람을 수거했다.",
				"누가 그 방송을 틀었을까. 그걸 다음에 알아본다.",
			],
			"reward": {
				"canned_food": 8,
				"churu": 1,
			...
			"lore": "수거 완료 명단 · 종로 지하철역\n역무실 단말에 남아 있던 명단이다. 이름이 스물일곱 개인데, 전부 종로에 살던 사람들이다. 맨 위에 도장이 하나 찍혀 있고 ‘수거 완료’라고 적혀 있다. 도장 날짜는 사람들이 사라진 그날 밤이다.",
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"지난번에 알아낸 것은 이렇다. 사람들은 방송을 듣고 제 발로 걸어 나갔다.",
							"그럼 사람들은 어디로 걸어갔을까. 그게 오늘의 질문이다.",
							"도로 밑에서 물소리가 난다.",
								"수돗물은 사람들이 사라진 날 끊겼다.",
								"그런데 지금 물이 흐르고 있다. 이상하다.",
							"도로 옆 배관 표지판에 밸브 위치가 세 군데 적혀 있다.",
							"밸브 세 개를 순서대로 열면 마지막 밸브실이 열린다.",
								"거기에 답이 있을 거다. 1번 밸브부터 연다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
				"point_1": [
					...
					{"type": "flash", "color": "#6fb7d8", "pulses": 2, "duration": 0.8},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"두 번째 밸브를 열었다. 그러자 도로 건너편에 불빛이 켜졌다.",
							"가로등 불빛이 아니다. 손전등 불빛이다. 여덟 개다.",
							"저쪽 사람들도 물소리를 들은 모양이다.",
								"들키면 안 된다. 몸을 낮추고 마지막 밸브실로 간다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
				"recovery": [
					{
						...
						"lines": [
							"배관도가 벽에 걸려 있다.",
								"인쇄된 선 위에 누가 다른 잉크로 선을 하나 더 그어 놓았다.",
							"그 선은 본선에서 갈라져서 지하로 내려가는 관이다.",
							"관 끝마다 같은 표시가 찍혀 있다. 신발 자국 모양이다.",
								"물이 가는 길이 아니라 사람이 내려간 길을 그려 둔 걸까.",
								"이 배관도를 뜯어서 들고 나간다.",
						],
					},
					{
						...
						"options": [
							{
								...
								"effect": {
									...
									"monologue": [
										"밸브를 열어 두면 다음에 오는 놈도 이 길을 보게 된다.",
										"그래서 잠근다. 이 길은 아직 나만 아는 길이다.",
									],
								},
							},
							{
			...
			"points": [
				{
					...
					"complete_monologue": [
						"밸브를 열었다. 그런데 물이 이쪽으로 안 온다.",
							"물이 반대쪽으로 빨려 나간다.",
						"관 끝이 어딘가 아래로 이어져 있다는 뜻이다.",
							"물이 가는 쪽에 뭔가 있다. 2번 밸브로 간다.",
					],
				},
				{
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 사람들이 걸어간 길은 지하로 이어진다.",
				"배관도에 누가 손으로 지하 통로를 그려 넣었다.",
					"관 끝마다 신발 자국 표시까지 찍어 놓았다.",
				"수도관 도면을 빌려서 사람이 내려가는 길을 그려 둔 거다.",
					"그 길이 어디서 끝나는지는 아직 모른다.",
			],
			"reward": {
				"canned_food": 11,
				"churu": 1,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "flash", "color": "#e2c15f", "pulses": 3, "duration": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"사람들을 걸어 나가게 만든 건 녹음된 여자 목소리였다.",
								"그 방송을 어디서 틀었는지 찾아야 한다.",
							"길가 스피커가 아직도 열두 초마다 같은 잡음을 낸다.",
								"방송국 기계가 아직 돌아가고 있다는 뜻이다.",
							"주조정실 문은 잠겨 있다.",
								"방송국 앞마당에 약탈대가 진을 치고 있다.",
								"약탈대가 방송국을 털었다면 열쇠도 그놈들 손에 있을 거다.",
								"약탈대부터 정리하고 열쇠를 뺏는다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				...
				"recovery": [
					{
						...
						"lines": [
							...
							"녹음 날짜를 봤다. 사람들이 사라지기 사흘 전이다.",
							"방송이 나가기도 전에 누구를 데려갈지 먼저 정해져 있었다는 뜻이다.",
								"이 기록을 뜯어서 들고 나간다.",
						],
					},
				],
			...
			"points": [
				{
					...
					"complete_monologue": [
						"열쇠를 손에 넣었다.",
							"열쇠에 이름은 없다. 직책만 찍혀 있다. ‘야간 송출 담당’이다.",
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 사람들을 부른 건 사람이 아니라 녹음된 방송이다.",
				"그리고 명단은 방송보다 사흘 먼저 만들어져 있었다.",
				"누가 미리 명단을 써서 방송국에 넘겼다.",
				"송출 기록에 명단을 넘긴 곳이 적혀 있었다. 남대문 시장이다.",
					"다음 질문은 그 명단을 누가 썼느냐다. 남대문으로 간다.",
			],
			"reward": {
				"canned_food": 14,
				"churu": 2,
			...
			"lore": "사흘 먼저 만든 명단 · 종로 방송국\n마지막 방송의 원고는 대피 안내가 아니었다. 이름 스물일곱 개짜리 목록이었다. 녹음 날짜가 사람들이 사라진 날보다 사흘 앞선다. 방송을 틀기 전에 누구를 부를지 이미 정해져 있었다는 뜻이다. 명단을 방송국에 넘긴 곳은 남대문 시장이다.",
		},
	],
	# ── 남대문 폐시장 ────────────────────────────────────────────
	...
	"namdaemun_market": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"종로에서 알아낸 것은 이렇다. 스물일곱 명의 명단은 남대문에서 방송국으로 넘어갔다.",
							"그러니까 그 명단을 쓴 누군가가 이 시장 어딘가에 있었다.",
							"시장 한복판에 천막이 세 겹으로 쳐져 있다.",
								"바람을 막으려고 친 게 아니다. 뭔가를 숨기려고 친 거다.",
							"천막 쪽에서 냄새가 난다. 썩은 냄새가 아니다.",
								"아직 먹을 수 있는 음식 냄새다.",
								"좌판 밑에 작은 발자국이 천막 쪽으로 이어져 있다.",
								"좌판 밑 발자국부터 따라가 본다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				...
				"recovery": [
					{
						...
						"title": "천막 밑 상자",
						"lines": [
							"상자를 열었다. 안은 전부 고양이 사료다.",
								"사람이 먹는 음식은 하나도 없다.",
							"상자 바닥에 배급표가 깔려 있다. 날짜가 오늘까지 찍혀 있다.",
							"정리하면 이렇다. 사람들이 사라진 뒤로 반년이 지났다.",
								"그 반년 동안 누가 고양이들한테만 몰래 밥을 대 주고 있다.",
								"왜 고양이한테만 줄까. 일단 이 상자를 어떻게 할지 정한다.",
						],
					},
					{
						"type": "choice",
						...
						"options": [
							{
								...
								"effect": {
									...
									"notice": "상자 전량 회수",
									"monologue": [
										"쉘터에는 오늘 밤 먹을 게 없는 고양이가 여럿이다.",
										"전부 가져간다. 미안한 마음은 나중에 갖자.",
									],
								},
							},
							{
								...
								"effect": {
									...
									"monologue": [
										"상자가 비어 있으면 채우던 놈이 눈치를 챈다.",
										"절반만 가져간다. 나는 아직 그놈을 못 봤으니까.",
									],
								},
							},
						],
			...
			"points": [
				{
					...
					"complete_monologue": [
						"좌판 밑에 발자국이 이어져 있다.",
							"사람 발자국이 아니다. 고양이 발자국이다.",
						"같은 발자국이 밤마다 여기를 지나간 모양이다.",
							"발자국을 따라 골목 안쪽으로 간다.",
					],
				},
				{
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 사람들을 데려간 쪽이 고양이들한테 반년째 몰래 밥을 주고 있다.",
				"누가 공짜로 밥을 줄 리가 없다. 밥을 줬으면 시킨 일이 있다는 뜻이다.",
				"고양이한테 시킬 수 있는 일이 뭘까.",
					"글씨 쓰는 일이라면 말이 된다. 명단을 고양이가 썼을 수도 있다.",
			],
			"reward": {
				"canned_food": 16,
				"churu": 2,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "flash", "color": "#e7a847", "pulses": 3, "duration": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"남대문에서 지금까지 알아낸 것은 이렇다.",
								"누가 고양이들한테 반년째 몰래 밥을 대 주고 있다.",
							"밥을 반년이나 대 주려면 물건을 쌓아 둘 창고가 있어야 한다.",
								"시장에서 제일 큰 창고가 이 창고다.",
							"창고 셔터에 붉은 등이 아직 켜져 있다.",
								"배터리만으로는 반년을 못 버틴다. 누가 전기를 대 주고 있다.",
							"제어반을 누르면 셔터가 열린다.",
								"셔터가 열리는 동안 온 동네가 그 소리를 듣는다.",
							"그러니까 버틸 준비부터 하고 연다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				...
				"point_0": [
					{"type": "shake", "strength": 0.28, "duration": 0.4},
					{
						...
						"lines": [
							"창고 장부를 펼쳤다.",
								"반입 기록만 빼곡하다. 반출 기록은 한 줄도 없다.",
							"들어온 것은 전부 짐이다. 가방, 신발, 지갑이다.",
							"마지막 반입일은 사람들이 사라진 다음 날이다.",
							"사람들이 두고 간 짐을 누가 다음 날 전부 모아서 여기 넣고 잠갔다.",
								"왜 짐을 모았을까. 이 장부를 들고 나간다.",
						],
					},
				],
			},
			"points": [
				{
					...
					"complete_monologue": [
						"셔터를 지키던 건 사람이 아니라 자동 경보였다.",
							"경보에 아직 전기가 들어온다.",
						"누가 이 창고를 계속 잠가 두게 해 놨다는 뜻이다.",
							"셔터가 열릴 때까지 여기서 버틴다.",
					],
				},
			],
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 사람들 짐은 전부 이 창고에 있다.",
					"가방, 신발, 지갑까지 전부 있다.",
				"방송이 말했었다. 소지품은 두고 오라고.",
					"사람들은 정말로 다 두고 갔다.",
				"짐은 챙겨서 보관하고 사람만 데려갔다.",
					"버린 게 아니라 맡아 둔 거다. 왜 맡아 뒀을까.",
			],
			"reward": {
				"canned_food": 19,
				"churu": 2,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"창고에서 알아낸 것은 이렇다. 사람들 짐은 전부 창고에 맡겨져 있었다.",
							"시장 사무실 금고가 아직 안 털렸다.",
								"이 도시에서 그건 이상한 일이다.",
							"약탈대가 안 턴 게 아니다. 못 연 거다. 인장이 없으면 안 열리는 금고다.",
							"인장은 사무실 주인이 갖고 있었다.",
								"주인은 약탈대 거점 쪽에서 죽었다. 인장은 그놈들 손에 있을 거다.",
								"약탈대한테서 인장부터 뺏는다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				...
				"recovery": [
					{
						...
						"lines": [
							"금고에서 장부를 꺼냈다.",
								"돈 계산은 사람들이 사라지기 전날에서 끊긴다.",
							"그다음 장부터는 이름과 주소뿐이다. 스물일곱 줄이다.",
							"글씨 옆에 눌린 자국이 있다. 앞발 자국이다.",
							"주홍 말이 맞다. 이 명단은 사람이 아니라 고양이가 받아 적었다.",
								"어느 고양이일까. 이 장부를 어떻게 할지 정한다.",
						],
					},
					{
						"type": "choice",
						...
						"options": [
							...
							},
							{
								...
								"effect": {
									...
									"notice": "원본 소각 · 사본만 회수",
									"monologue": [
										"이 글씨를 쓴 고양이가 여기 다시 올 수도 있다.",
										"원본은 태운다. 그놈은 재만 보게 될 거다.",
									],
								},
							},
						],
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 사람 스물일곱 명의 명단을 받아 적은 건 고양이다.",
				"방송 명단도 창고 장부도 이 장부도 전부 같은 글씨다.",
					"한 마리가 다 썼다는 뜻이다.",
				"어떤 고양이가 왜 사람 명단을 썼을까.",
					"반년째 밥을 대 준 그 고양이와 같은 고양이일까.",
				"장부에 다음 인수처가 적혀 있다. 을지로다.",
			],
			"reward": {
				"canned_food": 22,
				"churu": 3,
			...
			"lore": "앞발 자국이 찍힌 장부 · 남대문 시장 사무실\n장부 뒷장에는 사람 이름이 스물일곱 줄 적혀 있다. 글씨는 방송국 명단, 창고 장부와 같다. 줄 옆마다 앞발 자국이 눌려 있다. 사람 명단을 받아 적은 것이 고양이였다는 뜻이다. 장부에 적힌 다음 인수처는 을지로다.",
		},
	],
	# ── 을지로 지하구역 ──────────────────────────────────────────
	...
	"euljiro_depths": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"남대문에서 알아낸 것은 이렇다. 명단을 쓴 건 고양이다.",
								"그리고 장부는 을지로로 넘어왔다.",
							"사람들이 걸어간 길은 지하로 이어져 있었다.",
								"여기가 그 지하다.",
							"이 동네만 아직 전기가 들어온다.",
								"누가 이 동네만 골라서 전기를 남겨 뒀다는 뜻이다.",
							"골목마다 배전반이 하나씩 있다. 셋 다 아직 불이 들어온다.",
							"배전반 세 개를 열면 그 전기가 어디로 가는지 보인다.",
								"전기를 따라가면 답이 나올 거다. 1번 배전반부터 연다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"points": [
				{
					...
					"complete_monologue": [
						"배전반에 쪽지가 붙어 있다. ‘3구역까지만 전기를 넣을 것’이라고 적혀 있다.",
						"3구역은 지상이 아니다. 지하다.",
							"누가 지하에 전기를 넣으라고 시켰다. 2번 배전반으로 간다.",
					],
				},
				{
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 남겨 둔 전기가 전부 지하 선로로 들어간다.",
				"사람이 없는 도시에서 누가 반년 넘게 지하철 선로에 전기를 대 주고 있었다.",
				"선로에 전기가 들어온다는 건, 그 위로 아직 뭔가 다닌다는 뜻이다.",
					"뭐가 다녔을까. 다음에 그걸 알아본다.",
			],
			"reward": {
				"canned_food": 24,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"선로에 전기가 들어온다면 그 위로 뭔가가 다녔다는 뜻이다.",
								"그게 뭔지 알아야 한다.",
							"선로에서 바퀴 자국이 옆 공방까지 이어진다.",
							"공방 문은 안에서 잠겨 있다. 제어반을 누르면 열린다.",
							"문이 열리는 동안 소리가 난다. 버틸 준비부터 한다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"points": [
				{
					...
					"complete_monologue": [
						"공방 바닥에 바퀴 자국이 여러 겹 남아 있다.",
						"여기는 수레를 만들던 곳이다.",
							"바퀴 자국이 크다. 사람을 실을 만큼 큰 수레다.",
							"문이 열릴 때까지 버틴다.",
					],
				},
			],
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 이 공방에서 사람을 실을 만큼 큰 수레를 만들었다.",
				"사람들은 지하까지 제 발로 걸어 내려왔다.",
					"여기서부터는 수레에 실려 갔다.",
				"수레까지 미리 만들어 뒀다. 처음부터 끝까지 계획된 일이라는 뜻이다.",
					"누가 수레를 굴리라고 승인했을까. 다음에 그걸 알아본다.",
			],
			"reward": {
				"canned_food": 27,
				"churu": 3,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"수레가 다녔다면 굴리라고 승인한 누군가가 있다.",
							"지하 관제실에 수송 기록이 통째로 남아 있다고 주홍한테 들었다.",
							"오늘은 이름 하나만 알아 가면 된다. 이 일을 시킨 자의 이름이다.",
							"관제실 문은 잠겨 있다. 문 앞에 적들이 진을 치고 있다.",
								"열쇠는 그놈들이 갖고 있을 거다. 관제실 열쇠부터 뺏는다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
				"recovery": [
					{
						...
						"lines": [
							"수송 기록이 통째로 남아 있다.",
								"수송은 열두 번 있었다. 전부 같은 선로를 썼다.",
							"매번 승인란에 같은 서명이 찍혀 있다.",
							"이름은 두 글자다. ‘사자’라고 적혀 있다.",
							"사자는 우리 쉘터의 그 사자다. 매일 밤 내 밥을 챙겨 주는 고양이다.",
								"내 이름을 장부에 적어 주던 그 글씨다. 꾹꾹 눌러 쓴 글씨다.",
							"동명이인이면 좋겠다. 하지만 이 글씨를 나는 매일 본다.",
								"그러니까 사람 수송을 승인한 건 사자다. 그게 이 서명의 뜻이다.",
								"믿고 싶지 않다. 그래도 이 기록을 들고 나간다.",
						],
					},
					{"type": "wait", "duration": 0.3},
					{
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 지하 수송 열두 번을 전부 승인한 서명은 사자다.",
				"우리 쉘터의 그 사자다.",
					"명단을 받아 적었다는 고양이도 아마 사자일 거다.",
				"아직 증거는 반쪽이다. 기록에 적힌 다음 장소는 용산 봉쇄선이다.",
				"그리고 오늘 밤에도 나는 사자 앞에 앉아서 밥을 받아야 한다.",
			],
			"reward": {
				"canned_food": 30,
				"churu": 4,
			...
			"lore": "열두 회차 승인란 · 을지로 지하 관제실\n지하 선로로 열두 번의 수송이 있었다. 회차마다 인원과 시각이 적혀 있다. 승인란에는 매번 같은 서명이 찍혀 있다. ‘사자’라고 적혀 있다. 마지막 회차 아래에 다음 예정지가 한 줄 적혀 있다. 용산이다.",
		},
	],
	# ── 용산 봉쇄선 ──────────────────────────────────────────────
	...
	"yongsan_blockade": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"을지로에서 알아낸 것은 이렇다. 지하 수송을 승인한 서명은 사자였다.",
							"그 수송은 이 용산 봉쇄선을 지나갔다.",
								"군이 몰랐을 리가 없다.",
							"검문소 두 곳에 단말이 아직 켜져 있다. 통과 기록이 남아 있을 거다.",
							"군이 사람들을 어느 쪽으로 보냈는지 확인한다. 1번 검문소부터 간다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"points": [
				{
					...
					"complete_monologue": [
						"검문 기록 마지막 줄을 읽었다. 통과 인원이 0명이다.",
						"봉쇄선은 사람이 밖으로 못 나가게 막고 있었다.",
							"그럼 사람들은 어디로 갔을까. 2번 검문소로 간다.",
					],
				},
				{
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 봉쇄선 통과 인원은 0명이다.",
					"군은 아무도 밖으로 내보내지 않았다.",
				"막기만 한 게 아니다. 군은 사람들을 도시 안쪽으로 몰았다.",
					"지하 입구가 있는 방향이다.",
				"군이 왜 민간인 수거를 도왔을까. 군대는 명령서 없이 안 움직인다.",
					"그 명령서를 찾는다.",
			],
			"reward": {
				"canned_food": 34,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"검문소에서 알아낸 것은 이렇다. 군은 사람들을 도시 안쪽으로 몰았다.",
							"군이 사람을 안으로 몰았다면, 군은 총을 어디로 겨눴을까.",
							"검문 기록 끝에 경계 명령서 번호가 적혀 있었다.",
								"명령서 원본은 탄약고 금고에 둔다고 적혀 있었다.",
								"명령서를 보려면 탄약고 봉인부터 뜯어야 한다.",
							"봉인을 뜯는 동안은 시끄럽다. 버틸 준비부터 한다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 군의 경계 대상은 무기고가 아니었다.",
					"경계 대상은 도시 안쪽 주소들이었다.",
				"군은 총구를 바깥이 아니라 도시 안쪽으로 겨누고 있었다.",
					"사람들이 도망치지 못하게 막으려는 거였다.",
				"군과 민간 협력자 사이에 오간 종이 한 장만 더 찾으면 된다.",
					"그 종이를 찾으면 전부 설명이 된다.",
			],
			"reward": {
				"canned_food": 38,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"탄약고에서 알아낸 것은 이렇다. 군은 도시 안쪽 사람들을 겨누고 있었다.",
							"군이 도왔다면 종이가 남았을 거다.",
								"군은 종이 없이 안 움직인다.",
							"명령서 맨 아래에 협조 각서 원본은 사령부 금고에 둔다고 적혀 있었다.",
							"금고는 인증표가 있어야 열린다.",
								"인증표는 정예 병력이 지키는 구역에 있다. 인증표부터 뺏는다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
				"recovery": [
					{
						...
						"lines": [
							"금고를 열었다. 안에 무기는 없다.",
								"종이 한 장이 들어 있다. 군과 민간이 맺은 협조 각서다.",
							"각서는 수송 열두 회차분이다.",
							"요청한 쪽 서명은 사자다. 승인한 쪽 서명은 군 사령관이다.",
							"이제 증거는 반쪽이 아니다.",
								"사자가 군한테 직접 부탁해서 사람들을 실어 보냈다.",
								"이 각서가 그 증거다. 이 종이를 들고 나간다.",
						],
					},
					{"type": "wait", "duration": 0.3},
					{
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 군은 알고도 도왔다.",
					"군한테 서면으로 요청한 쪽은 사자다.",
				"그리고 주홍이 명단 열아홉 번째 줄에서 자기 집 사람 이름을 찾았다.",
				"주홍한테 이건 이제 조사가 아니다. 복수다.",
				"각서 끝에 수송 종착지가 적혀 있다. 남산이다. 마지막 장소다.",
			],
			"reward": {
				"canned_food": 42,
				"churu": 6,
			...
			"lore": "군·민간 협조 각서 · 용산 사령부\n종이 한 장짜리 각서다. 수송 열두 회차 동안 군이 봉쇄선을 유지한다고 적혀 있다. 민간 협력자는 명단을 제공한다고 적혀 있다. 요청한 쪽 서명은 사자다. 승인한 쪽 서명은 사령관이다. 각서 끝에 수송 종착지가 한 줄 적혀 있다. 남산이다.",
		},
	],
	# ── 남산 관제탑 ──────────────────────────────────────────────
	...
	"namsan_core": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"용산에서 알아낸 것은 이렇다. 수송의 종착지는 남산이다.",
								"사람들은 이 산 어딘가로 들어갔다.",
							"그런데 지도에서 남산은 오염 구역으로 찍혀 있다.",
								"그래서 아무도 이 산에 안 올라온다.",
							"산 초입에 오염 관측기가 세 개 서 있다.",
							"관측기 세 개를 맞춰야 원본 수치를 읽을 수 있다.",
							"그 숫자가 진짜인지부터 확인한다.",
								"가짜라면 여긴 오염 구역이 아니다. 뭔가를 숨겨 둔 곳이다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"points": [
				{
					...
					"complete_monologue": [
						"관측기 안쪽에 수치가 두 벌 있다.",
							"하나는 표시용 수치고, 하나는 실제 수치다.",
						"실제 수치는 종로보다 낮다.",
							"누가 숫자를 고쳐 놓은 걸까. 2번 관측기로 간다.",
					],
				},
				{
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 남산의 오염 수치는 조작이다.",
					"실제로는 종로보다 깨끗하다.",
				"누가 위험하다고 거짓말을 해서 아무도 못 올라오게 만든 거다.",
				"이렇게까지 숨기는 산이면 숨긴 게 있다.",
					"숨긴 건 아마 사람들이다. 더 올라가 본다.",
			],
			"reward": {
				"canned_food": 46,
				"churu": 6,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"관측기에서 알아낸 것은 이렇다. 남산 오염 수치는 가짜였다.",
							"관제탑 문이 잠겨 있다.",
							"문 옆 표지에 제염 라인이 돌아야 문이 열린다고 적혀 있다.",
							"제어반을 누르면 제염 라인이 돈다.",
							"라인이 도는 동안 나는 여기 서서 버틴다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"points": [
				{
					...
					"complete_monologue": [
						"기계가 돈다.",
							"사람이 사라진 뒤로도 계속 예약이 걸려 있었다.",
						"누가 아직 이 기계를 쓸 생각이라는 뜻이다.",
							"라인이 다 돌 때까지 버틴다.",
					],
				},
			],
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 제염 기계가 아직 예약된 채로 돌아간다.",
				"수거는 끝난 일이 아니다.",
					"이 기계에는 열세 번째 수송이 예약되어 있다.",
				"다음 명단 칸은 비어 있다.",
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "flash", "color": "#e2c15f", "pulses": 3, "duration": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"여기가 끝이다. 맨 위층에 그 방송을 틀던 방이 있다.",
							"사람들을 실어 나른 기계도 같은 방에 있다.",
							"올라가서 두 가지를 정한다.",
								"지하에 있는 사람들을 어떻게 할지, 그리고 이 기계를 어떻게 할지.",
							"맨 위층 문은 코드로 잠겨 있다.",
								"코드는 중무장한 놈들이 갖고 있다. 코드부터 뺏는다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
				"recovery": [
					{
						...
						"lines": [
							...
							"열두 번의 수송이 전부 남산 아래 한 곳으로 들어갔다.",
								"사람들은 거기에 있다.",
							"화면에 사람들 상태가 떠 있다.",
								"죽은 게 아니다. 살아서 잠들어 있다. 깨울 수도 있다.",
							"콘솔에 손잡이가 둘 있다. 하나는 시스템 정지, 하나는 기상이다.",
							"전력이 모자라서 둘 다는 안 된다. 하나만 당길 수 있다.",
								"정리하면 이렇다. 기계를 끄면 사람들은 그대로 잠든다.",
								"사람들을 깨우면 기계는 계속 돌아간다.",
								"어느 쪽을 고를까. 여기서 정한다.",
						],
					},
					{
						...
						"options": [
							{
								...
								"effect": {
									...
									"monologue": [
										"기계를 껐다. 열세 번째 수송은 없다.",
										"지하에 있는 사람들은 그대로 잔다. 나는 그 사람들을 못 깨운다.",
										"대신 기계는 더 이상 아무도 못 데려간다. 오늘은 그걸로 됐다.",
									],
								},
							},
							{
								...
								"effect": {
									...
									"monologue": [
										"사람들을 깨웠다. 지하에서 문이 하나씩 열린다.",
										"사람들이 걸어 올라온다. 이번에는 아무도 안 웃는다.",
										"기계는 못 껐다. 이 기계는 언젠가 다시 명단을 만들 거다.",
									],
								},
							},
						],
			...
			"carry_monologue": [
				"알아낸 것은 이렇다. 사람들은 남산 지하에 살아 있었다.",
				"그리고 나는 방금 하나를 골랐다. 잘 골랐는지는 모르겠다.",
				"남은 일은 하나다. 쉘터로 돌아가서 사자한테 직접 묻는 거다.",
			],
			"reward": {
				"canned_food": 60,
				"churu": 9,
			...
			"lore": "사람들은 아직 자고 있다 · 남산 관제탑\n사람들은 도망친 게 아니라 수거됐다. 녹음된 방송이 이름을 불렀다. 사람들은 걸어 나가서 지하 선로에서 수레에 실렸다. 열두 회차가 전부 남산 아래 한 곳으로 들어갔다. 그곳의 사람들은 아직 살아서 자고 있다. 명단을 받아 적은 것은 고양이였다. 수송을 요청한 서명은 사자였다.",
		},
	],
}
