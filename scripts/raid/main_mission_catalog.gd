				...
				"point_0": [
					{
						...
						"lines": [
							...
							"누가 이 사람들을 물건처럼 세어서 거둬 갔다. 그런 뜻이다.",
								"누가 이 사람들을 세어 놓은 걸까.",
								"역 발전기를 살리면 스피커가 뭘 틀었는지 들을 수 있다.",
						],
					},
				],
				"point_1": [
	...
	"namdaemun_market": [
		{
			...
			"carry_monologue": [
				...
				"세상에 공짜 밥은 없다. 밥을 줬으면 시킨 일이 있다는 뜻이다.",
				"고양이한테 시킬 수 있는 일이 뭘까.",
				...
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"lines": [
							"시장 사무실 금고가 아직 안 털렸다.",
								"이 도시에서 그건 이상한 일이다.",
							"약탈대가 못 연 게 아니다. 인장이 없으면 안 열리는 금고다.",
							"인장은 사무실 주인이 갖고 있었다.",
								"주인이 어디에 쓰러져 있는지는 약탈대가 안다. 인장부터 뺏는다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"lines": [
							"선로에 전기가 들어온다면 그 위로 뭔가가 다녔다는 뜻이다.",
								"그게 뭔지 알아야 한다.",
							"선로 옆 공방 문이 안에서 잠겨 있다. 제어반을 누르면 열린다.",
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"군이 사람을 안으로 몰았다면, 총은 어디를 보고 있었을까.",
							"탄약고 안에 명령서가 있다.",
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"lines": [
							...
							"그런데 지도에서 남산은 오염 구역으로 찍혀 있다.",
								"그래서 아무도 이 산에 안 올라온다.",
							"오염 관측기 세 개를 맞추면 원본 수치를 읽을 수 있다.",
							"그 숫자가 진짜인지부터 확인한다.",
