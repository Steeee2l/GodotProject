	...
	"jongno_outskirts": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "flash", "color": "#62c9ca", "pulses": 2, "duration": 0.9},
					{
						...
						"lines": [
							"라디오가 나를 불렀다. 그 신호를 따라 여기까지 왔다.",
							"발신지는 저 지하철역이다. 입구가 잠겨 있다 — 밖이 아니라 안에서.",
							"안에서 잠갔다는 건, 잠근 놈이 안에 있었다는 거다.",
							"오늘 알고 싶은 건 하나. 이 동네 사람들이 다 어디로 갔나.",
						],
					},
			...
			"points": [
				...
				},
				{
					...
					"complete_monologue": [
						...
						"이 목소리, 나를 강 건너로 부른 라디오와 같은 목소리다.",
						"사람들을 데려간 방송과 나를 부른 신호가 같은 곳에서 나왔다. 우연일 리가 없다.",
					],
				},
			],
			"recovery": {
			...
			"carry_monologue": [
				"오늘 알아낸 것. 사람들은 납치당한 게 아니다. 방송이 부르니까 제 발로 걸어 나갔다.",
				"명단도 있었다. 스물일곱 명. 도장까지 찍어 가며 사람을 ‘수거’했다.",
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"지난번에 알아낸 것. 사람들은 방송을 듣고 제 발로 걸어 나갔다.",
							"그럼 어디로 걸어갔을까. 그게 오늘의 질문이다.",
							"도로 밑에서 물소리가 난다. 수돗물은 사람들이 사라진 날 끊겼는데, 이상하잖아.",
							"밸브 셋을 순서대로 열면 마지막 방이 열린다. 거기 답이 있을 거다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"points": [
				{
					...
					"complete_monologue": [
						...
						"관 끝이 어딘가 아래로 이어져 있다. 물이 가는 쪽에 뭔가 있다.",
					],
				},
				{
			...
			"carry_monologue": [
				"알아낸 것. 사람들이 걸어간 길은 지하로 이어진다.",
				"배관도에 누가 손으로 지하 통로를 그려 넣었다. 관 끝마다 신발 자국 표시까지.",
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "flash", "color": "#e2c15f", "pulses": 3, "duration": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"사람들을 걸어 나가게 만든 그 여자 목소리. 어디서 틀었는지 찾아야 한다.",
							"길가 스피커가 아직도 열두 초마다 같은 잡음을 뱉는다. 방송국이 아직 돌고 있다는 뜻이다.",
							"주조정실은 잠겼다. 열쇠를 든 약탈대부터 정리한다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
				...
				"recovery": [
					{
						...
						"lines": [
							...
							"녹음 날짜를 봤다. 사람들이 사라지기 사흘 전.",
							"방송이 나가기도 전에, 누굴 데려갈지부터 정해져 있었다는 거다.",
						],
					},
				],
			},
			...
			"carry_monologue": [
				"알아낸 것. 사람들을 부른 건 사람이 아니라 녹음된 방송이다.",
				"그리고 명단은 방송보다 사흘 먼저 만들어져 있었다.",
				"누가 미리 명단을 써서 방송국에 넘겼다. 다음 질문은 그 명단이 어디서 왔느냐다.",
				"송출 기록에 넘긴 곳이 적혀 있었다. 남대문 시장.",
			],
			"reward": {
				"canned_food": 14,
				"churu": 2,
	...
	"namdaemun_market": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"종로에서 알아낸 것. 스물일곱 명의 명단은 남대문에서 방송국으로 넘어갔다.",
							"그러니까 그 명단을 쓴 손이 이 시장 어딘가에 있었다는 거다.",
							"시장 한복판에 천막이 세 겹으로 쳐져 있다. 바람 막으려는 게 아니라 뭘 숨기려는 거다.",
							"냄새가 난다. 썩은 냄새가 아니라, 아직 먹을 수 있는 것의 냄새.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
				...
				"recovery": [
					{
						...
						"lines": [
							...
							"정리하면 이렇다. 사람들이 사라진 뒤로 반년째, 누가 고양이들한테만 몰래 밥을 대 주고 있다.",
						],
					},
					{
						"type": "choice",
			...
			"carry_monologue": [
				"알아낸 것. 사람들을 데려간 쪽이 고양이들한테는 반년째 몰래 밥을 주고 있다.",
				"세상에 공짜 밥은 없다. 밥을 줬으면 시킨 일이 있다.",
				"고양이한테 시킬 수 있는 일이 뭘까. …글씨 쓰는 일이라면, 말이 된다.",
			],
			"reward": {
				"canned_food": 16,
				"churu": 2,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "flash", "color": "#e7a847", "pulses": 3, "duration": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"셔터에 붉은 등이 아직 켜져 있다. 배터리로는 반년을 못 버틴다. 전기를 대 주는 놈이 있다.",
							"제어반을 누르면 셔터가 열린다. 열리는 15초 동안 온 동네가 그 소리를 듣는다.",
							"그러니까 버틸 준비부터 하고 연다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
			...
			"carry_monologue": [
				"알아낸 것. 사람들 짐은 전부 이 창고에 있다. 가방, 신발, 지갑까지.",
				"방송이 말했었다. 소지품은 두고 오시라고. 사람들은 정말로 다 두고 갔다.",
				"짐은 챙겨서 보관하고 사람만 데려갔다. 버린 게 아니라 맡아 둔 거다. 왜?",
			],
			"reward": {
				"canned_food": 19,
				"churu": 2,
		...
		},
		{
				...
				"recovery": [
					{
						...
						"lines": [
							...
							"글씨 옆에 눌린 자국이 있다. 앞발 자국.",
							"주홍 말대로다. 이 명단, 사람이 아니라 고양이가 받아 적었다.",
						],
					},
					{
						"type": "choice",
			...
			"carry_monologue": [
				"알아낸 것. 사람 스물일곱 명의 명단을 받아 적은 건 고양이다.",
				"방송 명단도 창고 장부도 이 장부도 전부 같은 필체다. 한 마리가 다 썼다.",
				"어떤 고양이가, 왜 사람 명단을 썼을까. 반년째 밥을 대 준 그 손과 같은 손일까.",
	...
	"euljiro_depths": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"남대문에서 알아낸 것. 명단을 쓴 건 고양이고, 장부는 을지로로 넘어왔다.",
							"그리고 사람들이 걸어간 길은 지하로 이어져 있었다. 여기가 그 지하다.",
							"이 동네만 아직 전기가 들어온다. 누가 골라서 살려 뒀다는 얘기다.",
							"배전반 셋을 열면 그 전기가 어디로 가는지 보인다. 전기를 따라가면 답이 나온다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"carry_monologue": [
				"알아낸 것. 살려 둔 전기가 전부 지하 선로로 들어간다.",
				"사람이 없는 도시에서 반년 넘게 지하철 선로에 전기를 대 주고 있었다.",
				"선로가 살아 있다는 건, 그 위로 아직 뭔가 다닌다는 거다.",
			],
			"reward": {
				"canned_food": 24,
				"churu": 3,
		...
		},
		{
			...
			"carry_monologue": [
				"알아낸 것. 이 공방에서 사람을 실을 만큼 큰 수레를 만들었다.",
				"사람들은 지하까지 제 발로 걸어 내려왔고, 여기서부터는 수레에 실려 갔다.",
				"수레까지 미리 만들어 뒀다. 즉흥이 아니라 처음부터 끝까지 계획된 일이다.",
			],
			"reward": {
				"canned_food": 27,
				"churu": 3,
		...
		},
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"수레가 다녔으면, 굴리라고 승인한 놈이 있다.",
							"지하 관제실에 수송 기록이 통째로 남아 있다고 했다.",
							"오늘은 이름 하나만 알아 가면 된다. 이 일을 시킨 놈의 이름.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
				"recovery": [
					{
						...
						"title": "수송 기록 · 승인란",
						"lines": [
							"수송 기록이 통째로 남아 있다. 열두 번, 전부 같은 선로.",
							"매번 승인란에 같은 서명이 찍혀 있다.",
							"이름 두 글자. ‘사자.’",
							"…사자. 매일 밤 내 밥을 챙겨 주고, 내 이름을 장부에 적던 그 사자.",
							"동명이인이면 좋겠는데, 이 꾹꾹 눌러 쓴 글씨를 나는 매일 본다.",
						],
					},
					{"type": "wait", "duration": 0.3},
					{
					...
					},
					{
						...
						"lines": [
							...
							"아직 쏘지는 마. 서명 하나로는 반쪽짜리 증거야.",
							"용산 봉쇄선에 가면 나머지 반쪽이 있어. 군이 낀 일엔 반드시 종이가 남거든.",
							"먼저 가서 기다릴게. …너, 오늘 밤 걔 앞에서 밥 넘어가겠어?",
						],
					},
					{
						"type": "actor_exit",
			...
			"carry_monologue": [
				"알아낸 것. 지하 수송 열두 번을 전부 승인한 서명은 사자다.",
				"우리 쉘터의 그 사자. 명단을 받아 적었다는 고양이 손도 아마 같은 손이다.",
				"아직 증거가 반쪽이다. 기록이 가리키는 다음 장소는 용산 봉쇄선.",
				"그리고 오늘 밤에도 나는 그 앞에 앉아서 밥을 받아야 한다.",
			],
			"reward": {
				"canned_food": 30,
				"churu": 4,
	...
	"yongsan_blockade": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"을지로에서 알아낸 것. 지하 수송을 승인한 서명은 사자였다.",
							"그 수송은 이 용산 봉쇄선을 지나갔다. 군이 몰랐을 리가 없다.",
							"검문소 단말 두 개에 기록이 남아 있다.",
							"군이 사람들을 어느 쪽으로 보냈는지, 그것만 확인하면 된다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"carry_monologue": [
				"알아낸 것. 봉쇄선 통과 인원은 0명이다. 군은 아무도 밖으로 내보내지 않았다.",
				"막은 게 아니라 몰았다. 사람들을 도시 안쪽, 지하 입구 방향으로.",
				"군이 왜 민간인 수거를 도왔을까. 군대는 명령서 없이는 안 움직인다. 그 종이를 찾는다.",
			],
			"reward": {
				"canned_food": 34,
				"churu": 4,
		...
		},
		{
			...
			"carry_monologue": [
				"알아낸 것. 군의 경계 대상은 무기고가 아니라 도시 안쪽 주소들이었다.",
				"총구가 바깥이 아니라 안을 보고 있었다. 사람들이 도망치지 못하게.",
				"군과 그 ‘민간 협력자’ 사이에 오간 종이 한 장만 더 찾으면 그림이 완성된다.",
			],
			"reward": {
				"canned_food": 38,
				"churu": 5,
		...
		},
		{
				...
				"recovery": [
					{
						...
						"lines": [
							...
							"이제 반쪽이 아니다. 사자가 군한테 직접 부탁해서 사람들을 실어 보냈다.",
						],
					},
					{"type": "wait", "duration": 0.3},
					{
			...
			"carry_monologue": [
				"알아낸 것. 군은 알고도 도왔다. 서면으로 요청한 쪽은 사자.",
				"그리고 주홍이 명단 열아홉 번째 줄에서 자기 집 사람 이름을 찾았다.",
				"주홍한테 이건 이제 조사가 아니다. 복수다.",
				"각서 끝에 수송 종착지가 적혀 있다. 남산. 마지막 장소다.",
			],
			"reward": {
				"canned_food": 42,
				"churu": 6,
	...
	"namsan_core": [
		{
			...
			"cinematics": {
				"intro": [
					...
					{"type": "focus", "at": "site", "hold": 1.0},
					{
						...
						"portrait": PORTRAIT_NABI_PATH,
						"lines": [
							"용산에서 알아낸 것. 수송의 종착지는 남산이다. 사람들은 이 산 어딘가로 들어갔다.",
							"그런데 지도에서 남산은 오염 구역으로 찍혀 있다. 그래서 아무도 안 올라온다.",
							"오염 관측기 셋을 맞추면 원본 수치가 읽힌다.",
							"그 숫자가 진짜인지부터 확인한다. 가짜라면, 여긴 오염 구역이 아니라 금고다.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
			...
			"carry_monologue": [
				"알아낸 것. 남산의 오염 수치는 조작이다. 실제로는 종로보다 깨끗하다.",
				"위험하다고 거짓말을 해서 아무도 못 올라오게 만든 거다.",
				"이렇게까지 숨기는 산이면, 숨긴 게 있다. 사람들이겠지.",
			],
			"reward": {
				"canned_food": 46,
				"churu": 6,
		...
		},
		{
			...
			"carry_monologue": [
				"알아낸 것. 제염 기계가 아직 예약된 채로 돌아간다.",
				"수거는 끝난 일이 아니다. 이 기계는 열세 번째 수송을 기다리고 있다.",
				"다음 명단 칸은 비어 있다. 누가 채우기 전에 여길 끝내야 한다.",
			],
			"reward": {
				"canned_food": 52,
				"churu": 7,
				...
				"intro": [
					...
					{"type": "flash", "color": "#e2c15f", "pulses": 3, "duration": 1.0},
					{
						...
						"lines": [
							...
							"올라가서 정한다. 잠든 사람들을 어떻게 할지, 이 기계를 어떻게 할지.",
						],
					},
					{"type": "focus_player", "hold": 0.3},
				],
